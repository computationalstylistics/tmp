---
title: Metody ilościowe w badaniach zmian językowych
author: Maciej Eder
date: 25 X 2017
output: 
...
![title](lem_no-labels.png){width=1200px}
...
```{r fig-1, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
sredni.wynik = c()
...
```{r fig-2, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-3, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-4, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-4a, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-5, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
wynik = y$ze / y$dlugosc
sredni.wynik = c()
for(i in unique(y$rok)) {
   sredni.wynik = c( sredni.wynik, mean(wynik[y$rok == i]) )
...
```{r laws1, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r laws2, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r laws3, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-10, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-11, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-12, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-13, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-14, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-15, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-16, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
#       add_trace(y = model$fitted, name = 'abo > albo', mode = 'lines', line = list(color = my.p.violet, width = 3, dash = 'dash'))  %>%
       add_trace(y = lowess(x$albo, f=1/7)$y, name = 'abo > albo', mode = 'lines', line = list(color = my.p.violet, width = 3)) %>%
       layout(
           xaxis = list(range = c(1350, 2050)),
           yaxis = list(range = c(-0.1, 1.1), zeroline = FALSE),
           annotations = annotation)
...
```{r fig-20, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
```{r fig-21, echo=FALSE, message=FALSE, fig.width=10, fig.height=6}
model.wiekszy = glm(x$wiekszy ~ dates, family=quasibinomial(logit))
model.bysmy_bym = glm(x$bysmy_bym ~ dates, family=quasibinomial(logit))
model.bardzo = glm(x$bardzo ~ dates, family=quasibinomial(logit))
model.naj = glm(x$naj ~ dates, family=quasibinomial(logit))
